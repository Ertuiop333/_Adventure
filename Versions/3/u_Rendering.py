...
def __write_render_object_to_screen_data(object: Components.Renderer):
    for pixel in object.sprite.pixels:
        newX = pixel.position.x + object.sprite.offset.x + object.master_entity.position.x - camera_pos.x
        newY = pixel.position.y + object.sprite.offset.y + object.master_entity.position.y - camera_pos.y
        if (
            ...
            Terminal.screen_data[newX][newY] = pixel.character
